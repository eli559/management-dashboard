    ...
    return (
      <div className="w-full">
        ...
        <div className="relative">
          {Icon && (
            <Icon className="absolute start-4 top-1/2 -translate-y-1/2 w-5 h-5 text-zinc-300 pointer-events-none" />
          )}
          <input
            ref={ref}
            id={id}
            className={cn(
              "w-full py-3 bg-white/[0.03] border border-white/[0.08] rounded-xl text-sm text-zinc-200 placeholder:text-zinc-300",
