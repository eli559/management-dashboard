        ...
        {events.length > 0 ? (
          <div className="space-y-0.5">
            {events.map((event) => (
              ...
              >
                <div className="w-9 h-9 rounded-lg flex items-center justify-center flex-shrink-0 bg-white/[0.04] border border-white/[0.06] text-zinc-500 transition-transform duration-200 group-hover:scale-105">
                ...
                <span className="text-[10px] text-zinc-600 flex-shrink-0 mt-1 font-medium">
