...
export function TopProjects({ projects }: TopProjectsProps) {
  ...
  return (
    <div className="relative glass rounded-2xl p-6 animate-slide-up stagger-6 overflow-hidden">
      ...
      <p className="text-[13px] text-zinc-300 mb-5">לפי מספר אירועים</p>
      ...
      <div className="space-y-1">
        {projects.map((project, idx) => (
          ...
          >
            <div className="w-8 h-8 rounded-lg bg-white/[0.04] border border-white/[0.06] flex items-center justify-center text-zinc-300 flex-shrink-0">
