...
export function ComparisonChart({ comparison, days, className }: ComparisonChartProps) {
  ...
  return (
    <div className={cn("surface rounded-2xl p-6 overflow-hidden relative", className)}>
      ...
      <p className="text-[12px] text-zinc-300 mb-5">{days} ימים אחרונים מול {days} ימים לפני</p>
      ...
      <div className="flex items-end gap-6 justify-center mb-4">
        ...
        <div className="flex flex-col items-center gap-2 flex-1">
          ...
          <p className="text-[18px] font-bold text-zinc-300">{formatNumber(previous)}</p>
          <p className="text-[10px] text-zinc-300">תקופה קודמת</p>
        </div>
        ...
        <div className="flex flex-col items-center gap-2 flex-1">
          ...
          <p className="text-[10px] text-zinc-300">תקופה נוכחית</p>
        </div>
      </div>
    </div>
  );
