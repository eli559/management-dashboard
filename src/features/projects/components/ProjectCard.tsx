      ...
      <div className="surface rounded-2xl p-6 h-full flex flex-col hover:bg-white/[0.05] hover:-translate-y-0.5 transition-all duration-300 overflow-hidden relative">
        ...
        <div className="flex items-center gap-2 mb-4">
          ...
          <div className="flex items-center gap-1.5">
            ...
            <span className="text-[11px] text-zinc-300 font-medium">{PROJECT_STATUS_LABELS[status]}</span>
          </div>
        </div>
        ...
        {description && (
          <p className="text-[13px] text-zinc-300 leading-relaxed line-clamp-2 mb-4">{description}</p>
        )}
        ...
        <div className="flex items-center gap-4 mb-3">
          <div className="flex items-center gap-1.5 text-zinc-300">
            ...
            <span className="text-[11px] text-zinc-300">אירועים</span>
          </div>
          {lastEventAt && (
            <div className="flex items-center gap-1.5 text-zinc-300">
