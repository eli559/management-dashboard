      ...
      <div className="animate-slide-up stagger-2 grid grid-cols-2 sm:grid-cols-4 gap-4">
        <div className="surface-sm rounded-xl p-4">
          <div className="flex items-center gap-2 mb-2">
            ...
            <span className="text-[11px] text-zinc-400">סה״כ מבקרים</span>
          </div>
        ...
        <div className="surface-sm rounded-xl p-4">
          <div className="flex items-center gap-2 mb-2">
            ...
            <span className="text-[11px] text-zinc-400">היום</span>
          </div>
        ...
        <div className="surface-sm rounded-xl p-4">
          <div className="flex items-center gap-2 mb-2">
            ...
            <span className="text-[11px] text-zinc-400">השבוע</span>
          </div>
        ...
        <div className="surface-sm rounded-xl p-4">
          <div className="flex items-center gap-2 mb-2">
            ...
            <span className="text-[11px] text-zinc-400">ממוצע פעולות</span>
          </div>
              ...
              <div className="space-y-2">
                {stats.sessionsByProject.map((p) => (
                  ...
                  >
                    ...
                    <span className="text-[12px] text-zinc-400 tabular-nums font-medium">{p.count} מבקרים</span>
              ...
              <div className="space-y-2">
                {stats.topReferrers.map((r) => (
                  <div key={r.referrer} className="flex items-center gap-3 p-2">
                    ...
                    <span className="text-[12px] text-zinc-400 tabular-nums font-medium">{r.count}</span>
                  </div>
                ))}
              </div>
            </div>
              ...
              <table className="w-full">
                <thead>
                  <tr className="border-b border-white/[0.05]">
                    ...
                    <th className="text-start text-[11px] font-semibold text-zinc-400 uppercase tracking-wider px-5 py-3">עמודים</th>
                    ...
                    <th className="text-start text-[11px] font-semibold text-zinc-400 uppercase tracking-wider px-5 py-3">אירועים</th>
                    <th className="text-start text-[11px] font-semibold text-zinc-400 uppercase tracking-wider px-5 py-3">נכנס</th>
                    ...
                    >
                      ...
                      <td className="px-5 py-3">
                        <div className="flex flex-wrap gap-1 max-w-[200px]">
                          {session.pages.slice(0, 3).map((page) => (
                            <code key={page} className="text-[10px] text-zinc-400 font-mono bg-white/[0.04] px-1.5 py-0.5 rounded" dir="ltr">
                              {page}
                            </code>
                          ))}
                          {session.pages.length > 3 && (
                            <span className="text-[10px] text-zinc-400">+{session.pages.length - 3}</span>
                          )}
                        </div>
                      </td>
                      ...
                      <td className="px-5 py-3">
                        <div className="flex flex-wrap gap-1 max-w-[200px]">
                          ...
                          {session.events.length > 2 && (
                            <span className="text-[10px] text-zinc-400">+{session.events.length - 2}</span>
                          )}
                        </div>
                      </td>
                      ...
                      <td className="px-5 py-3">
                        <div className="text-[11px]">
                          ...
                          <span className="text-zinc-400">{session.deviceName}</span>
                        </div>
                      </td>
